<div class="relative" x-data="{ open: @entangle('open') }">
    ...
    <div x-show="open" 
         ...
         class="absolute right-0 mt-2 w-[min(24rem,calc(100vw-1.5rem))] glass-card rounded-2xl shadow-2xl z-50 overflow-hidden outline-none">
        ...
        <div class="max-h-80 overflow-y-auto">
            ...
            @empty
                <div class="px-4 py-8 text-center">
                    <div class="empty-state-icon mx-auto mb-3 w-12 h-12">
