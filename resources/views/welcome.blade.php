...
<body class="antialiased bg-slate-50 dark:bg-[#060910] text-gray-900 dark:text-gray-200 overflow-x-hidden selection:bg-blue-500 selection:text-white font-sans theme-transition">
    ...
    <!-- Navigation -->
    <nav x-data="{ mobileMenuOpen: false }" class="fixed w-full z-50 transition-all duration-300 bg-white/70 dark:bg-[#060910]/60 backdrop-blur-xl border-b border-gray-200/50 dark:border-white/[0.04] theme-transition">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="#stats" class="nav-link-premium text-gray-600 dark:text-gray-400 dark:hover:text-white">Stats</a>
                    @auth
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            Log in
                        </a>
                ...
                <div class="md:hidden flex items-center gap-3">
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="p-2.5 rounded-xl bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-400">
        ...
        <div x-show="mobileMenuOpen" 
             ...
             x-cloak
             class="md:hidden bg-white/95 dark:bg-[#060910]/95 backdrop-blur-2xl border-t border-gray-200/50 dark:border-white/[0.06] py-6 px-4 space-y-4 shadow-2xl">
            <a href="#features" @click="mobileMenuOpen = false" class="block py-2 text-lg font-semibold text-gray-900 dark:text-white">Features</a>
            <a href="#stats" @click="mobileMenuOpen = false" class="block py-2 text-lg font-semibold text-gray-900 dark:text-white">Stats</a>
            <div class="pt-4 border-t border-gray-200/50 dark:border-white/[0.06] flex flex-col gap-3">
                @auth
                    <a href="{{ url('/dashboard') }}" class="w-full py-4 rounded-2xl bg-blue-600 text-white font-bold text-center">Open Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="w-full py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-bold text-center">Log In</a>
                    <a href="{{ route('register') }}" class="w-full py-4 rounded-2xl bg-blue-600 text-white font-bold text-center">Get Started Free</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <section class="relative pt-36 pb-20 lg:pt-52 lg:pb-36 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
            ...
            <h1 class="hero-animate hero-animate-delay-1 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 leading-[1.1] sm:leading-[0.9]">
                <span class="block text-gray-900 dark:text-white mb-2 sm:mb-3">Modern Vehicle</span>
                <span class="block bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 pb-1">
                    Management Platform
                </span>
            </h1>
